...
def scrape_matches(game: str):
    ...
    for section in sections:
        ...
        for match in section.select('.match'):
            ...
            timestamp = int(timer_span.get("data-timestamp")) if timer_span else None
            match_time = convert_timestamp_to_eest(timestamp) if timestamp else "N/A"
            ...
            match_id = details_link.split("Match:")[1] if "Match:" in details_link else None
